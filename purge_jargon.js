 ...
 * purge_jargon.js
 * 
 * Purges "System" + "Institutional" jargon from all UI-visible text
...
const REPLACEMENTS = [
  ...
  ['System Terminal', 'Secure Platform'],
  ['SOVEREIGN TERMINAL', 'SECURE PLATFORM'],
  ['system terminal', 'secure platform'],
  ['System Dashboard', 'Professional Dashboard'],
  ['SOVEREIGN DASHBOARD', 'PROFESSIONAL DASHBOARD'],
  ['System Identity', 'Verified Identity'],
  ['SOVEREIGN IDENTITY', 'VERIFIED IDENTITY'],
  ['System Ledger', 'Network Ledger'],
  ['SOVEREIGN LEDGER', 'NETWORK LEDGER'],
  ['System Vault', 'Secure Vault'],
  ['SOVEREIGN VAULT', 'SECURE VAULT'],
  ['System Intel', 'Network Intel'],
