...
import { DarkForestRadar } from '../omni-matrix/DarkForestRadar';
import { PredictionPulseFeed } from '../omni-matrix/PredictionPulseFeed';
import { ConcentratedLiquidityMap } from '../omni-matrix/ConcentratedLiquidityMap';
import { MigrationHologram } from '../omni-matrix/MigrationHologram';

export function OmniMatrixDashboard() {
    ...
    return (
        <div className="space-y-12 relative z-10">
            ...
            {/* Dark Data Matrix: MEV, Whales, Liquidity, Bridges */}
            <div className="space-y-6 pt-6 relative z-10">
                <div className="flex items-center gap-3 px-2">
                    <Globe size={18} className="text-cyan-400" />
                    <h3 className="text-2xl font-black text-white uppercase tracking-tight">Deep Liquidity & Intelligence</h3>
                </div>
