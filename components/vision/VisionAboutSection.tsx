...
const PILLARS = [
  {
    n: '01',
    title: 'Critical Infrastructure Auditing',
    desc: 'Comprehensive security, privacy, and performance evaluations for distributed networks. We apply structural intelligence derived from building global ecosystems to audit complex topologies and eliminate attack vectors.',
  },
  {
    n: '02',
  ...
  {
    n: '04',
    title: 'Open-Source, Trustless Rails',
    desc: 'Every tool we build is auditable. No middlemen, no honeypots, no single points of failure. Our codebase is public and our methodology is verifiable by design.',
  },
];
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-6 md:px-16 py-20 md:py-28">
        ...
        {/* Headline */}
        <h2 className="text-2xl md:text-[2.6rem] font-black tracking-tighter text-black leading-tight mb-4 max-w-xl">
          Prove your truth,<br className="hidden md:block" /> protect your assets.
        </h2>
        <p className="text-[14px] text-black/45 font-medium mb-14 max-w-2xl leading-relaxed">
          Humanity Ledger is a Valencian-born company pioneering critical infrastructure auditing and cryptographic privacy architecture for the decentralised economy.
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-start">
            ...
            <div className="mt-4 text-center">
              ...
              <div className="flex items-center justify-center gap-2 mt-3">
                ...
                >
                  ...
                  <span className="text-[8px] font-black uppercase tracking-wider">Company</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-5 text-[13px] md:text-[14px] leading-relaxed text-black/60 font-sans">
            <p>
              ...
              <span className="text-black font-semibold">Whale Alert Network</span> — one of the most widely used
            ...
            <p>
              ...
              <span className="text-black font-semibold">Critical Infrastructure Auditing</span>: comprehensive
              security, privacy, and performance evaluations for distributed networks. We apply the structural
              intelligence derived from creating global ecosystems to audit complex topologies, guaranteeing the
              mitigation of attack vectors and ensuring operational efficiency.
            </p>
            ...
            {/* Feature pillars */}
            <div className="pt-6 grid grid-cols-1 sm:grid-cols-2 gap-6 border-t border-black/6">
              {PILLARS.map((p) => (
