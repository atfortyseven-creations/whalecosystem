                ...
                <div className="shrink-0 w-full border-b border-black/[0.04] dark:border-white/10 bg-white/50 dark:bg-[#111111] backdrop-blur-md flex items-center px-6 overflow-x-auto whitespace-nowrap scrollbar-hide py-3 gap-8 relative z-10">
                    ...
                    {exchanges.map((ex) => (
                        <div key={ex.name} className="flex items-center gap-2 shrink-0">
                            ...
                            <span className="text-[10px] uppercase font-mono font-bold tracking-widest text-[#050505] dark:text-white">
                ...
                <div className="shrink-0 px-8 pt-8 pb-6 border-b border-black/[0.04] dark:border-white/10 flex flex-col md:flex-row md:items-end justify-between bg-gradient-to-b from-white/80 dark:from-[#1A1A1A] to-transparent relative z-10 gap-6">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-3xl md:text-4xl font-black uppercase tracking-tighter text-[#050505] dark:text-white flex items-center gap-3">
                            The Whale Post
                            <span className="px-2 py-0.5 rounded border border-black/10 dark:border-white/10 text-[9px] font-bold tracking-widest bg-black/5 dark:bg-white/10 text-[#888888] dark:text-white/60 align-middle mt-1">LIVE FEED</span>
                        </h1>
                        <p className="text-[10px] text-[#050505]/50 dark:text-white/50 font-bold uppercase tracking-[0.2em] leading-tight max-w-md">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        <div className="relative w-full md:w-72">
                            ...
                            />
                            {search && (
                                <button onClick={() => setSearch('')} className="absolute right-3 top-1/2 -translate-y-1/2 text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white">
                                    <ShieldCheck size={14} />
                                </button>
                            )}
                        </div>
                        <button onClick={() => refetch()} disabled={loading} className="p-3 bg-white dark:bg-[#1A1A1A] border border-black/10 dark:border-white/10 shadow-sm rounded-xl hover:bg-black/5 dark:hover:bg-white/10 hover:border-black/20 dark:hover:border-white/20 text-[#050505] dark:text-white transition-all disabled:opacity-50 active:scale-95 flex items-center justify-center">
