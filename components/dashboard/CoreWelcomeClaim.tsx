...
export default function CoreWelcomeClaim({ signature, onSuccess }: { signature: string, onSuccess: () => void }) {
    ...
    const handleClaim = async () => {
        ...
        setIsClaiming(true);
        try {
            // Simulating contract call to CoreAirdrop.claimWelcomeBonus(signature)
