...
const DOCS_LINKS = [
    ...
    { icon: <Code2 size={16} />,    label: 'Noir Circuits',         href: 'https://github.com/atfortyseven-creations/Humanity-Ledger', desc: 'Open-source ZK circuit implementations powering private execution.' },
