    ...
    <>
      ...
      <div className="w-full shadow-sm bg-white dark:bg-[#050505] border-b border-black/10 dark:border-white/5 transition-colors duration-300">
        <div className="max-w-[1110px] mx-auto px-4 flex items-center h-[54px] gap-4 md:gap-8 overflow-x-auto custom-scrollbar">
          <Link href="/" className="shrink-0 text-[10px] font-black uppercase tracking-[0.2em] h-full flex items-center transition-colors text-black dark:text-white hover:text-[#00C076] whitespace-nowrap">
            &larr; Return to Landing Page
          </Link>
          <div className="w-px h-4 bg-black/10 dark:bg-white/10 shrink-0 mx-2 hidden md:block" />
