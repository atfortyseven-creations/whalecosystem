...
const CHAINS = [
  { id: 999999,name: "Humanity Ledger", slug: "humanity", color: "#050505", symbol: "QDs",  explorer: "https://basescan.org" },
...
function ChainRow({
  ...
  const { data: qdBalanceRaw } = useReadContract({
      ...
      query: { enabled: chain.name === 'Humanity Ledger' && !!address }
  });
        ...
        {open && (
          ...
          >
            <div className="border-t" style={{ borderColor: BORDER }}>
              ...
              {!loading && !fetched && !chain.slug && chain.name !== 'Humanity Ledger' && (
                <div className="py-10 text-center">
