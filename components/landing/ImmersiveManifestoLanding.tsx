      ...
      >
        ...
        >
          <motion.div variants={FADE_UP} className="w-full max-w-[900px] mx-auto flex flex-col items-center justify-center gap-6">
            ...
            {mounted && (
              <div className="relative w-[420px] h-[420px] sm:w-[560px] sm:h-[560px] lg:w-[700px] lg:h-[700px] shrink-0 flex items-center justify-center mx-auto">
                <img
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 w-full mt-4 z-40 relative">
              <Link
                href="/portfolio"
