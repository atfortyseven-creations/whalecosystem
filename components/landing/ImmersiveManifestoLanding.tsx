      ...
      <section className="w-full min-h-[100dvh] bg-transparent relative z-10 flex flex-col justify-center items-center py-24">
        <div className="w-full max-w-[2560px] mx-auto px-6 md:px-12 xl:px-20 space-y-16">
            <div className="text-left max-w-5xl space-y-6 mb-20 mx-auto text-center flex flex-col items-center">
                ...
                <p className="font-serif text-[20px] md:text-[24px] text-slate-500 leading-relaxed max-w-3xl">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
                ...
                {/* Bento Card 1 */}
                <div className="col-span-1 xl:col-span-2 bg-white/70 backdrop-blur-[40px] rounded-[3rem] border border-white/60 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.06)] p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-12 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-500 overflow-hidden group">
                    <div className="w-full lg:w-1/2 space-y-8">
                        <h3 className="text-[36px] lg:text-[44px] font-black uppercase tracking-tight text-[#050505]">
                            Secure Integrity.
                        </h3>
                        <p className="text-[18px] lg:text-[20px] text-slate-500/90 leading-relaxed font-serif">
                    ...
                    <div className="w-full lg:w-1/2 h-full min-h-[380px] flex items-center justify-center bg-black/[0.02] rounded-[2rem] border border-black/5 overflow-hidden p-6 relative group-hover:bg-black/[0.04] transition-colors">
                        <RemoteLottie path="DeeWork About Blockchain.json" className="w-full h-full scale-125" />
                    </div>
                </div>

                {/* Bento Card 2 */}
                <div className="col-span-1 bg-white/70 backdrop-blur-[40px] rounded-[3rem] border border-white/60 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.06)] p-12 lg:p-16 flex flex-col justify-between hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-500 group">
                    <div className="w-full h-[260px] flex items-center justify-center bg-black/[0.02] rounded-[2rem] border border-black/5 mb-10 overflow-hidden p-4 relative group-hover:bg-black/[0.04] transition-colors">
                         <RemoteLottie path="Connected world.json" className="scale-125" />
                    </div>
                    <div className="space-y-6">
                        <h3 className="text-[32px] lg:text-[36px] font-black uppercase tracking-tight text-[#050505]">
                            Entity Resolution.
                        </h3>
                        <p className="text-[18px] lg:text-[20px] text-slate-500/90 leading-relaxed font-serif">
                ...
                <div className="col-span-1 bg-white/70 backdrop-blur-[40px] rounded-[3rem] border border-white/60 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.06)] p-12 lg:p-16 flex flex-col justify-between hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-500 group">
                    ...
                    <Link href="/dashboard" target="_blank" rel="noopener noreferrer" className="w-full h-[260px] flex items-center justify-center bg-black/[0.02] rounded-[2rem] border border-black/5 overflow-hidden p-4 relative group-hover:bg-black/[0.04] transition-colors">
