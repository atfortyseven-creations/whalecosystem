...
const FAQ_DATA: FAQItem[][] = [
    ...
    [
        ...
        { q: "What role does ZK-Intelligence play?", a: "We use zero-knowledge proofs to allow high-tier alerts without compromising the original provider's anonymity, preserving the alpha of the source.", tag: "PRIVACY" },
    ...
    [
        ...
        { q: "What is the advantage of our 'Ivory-and-Ink' theme?", a: "It is designed for institutional focus—eliminating visual noise while highlighting critical delta changes with high-contrast tactical accents.", tag: "UX" },
    ...
    [
        { q: "How does our tracker compare to legacy 'Smart Money' filters?", a: "We focus on 'Legendary' status—wallets with >$100M AUM and sustained 24-month profitability, rather than just transaction count.", tag: "INTEL" },
    ...
    [
        { q: "How do we select which assets are tracked?", a: "We prioritize assets by 'Sovereign Volatility'—liquid assets where institutional behavior has a statistically significant impact on price trajectory.", tag: "ASSETS" },
        ...
        { q: "What is the 'Institutional Grade' guarantee?", a: "A 99.9% data accuracy SLA verified by independent on-chain auditing nodes in the Sovereign Intelligence Network.", tag: "QUALITY" }
    ],
    ...
    [
        ...
        { q: "What is the 'Sovereign Audit' trail?", a: "A downloadable PDF report of any event, suitable for institutional compliance and internal risk review.", tag: "COMPLIANCE" },
    ...
    [
        ...
        { q: "Can I use the system via a VPN or TOR?", a: "Our nodes are globally distributed to ensure accessible intelligence regardless of your geographic location.", tag: "ACCESS" },
    ...
    [
        ...
        { q: "Community Governance: Who owns the system?", a: "The Sovereign Infrastructure Group manages the protocol with oversight from the DAO of institutional participants.", tag: "DAO" }
    ]
];
