...
const FAQ_DATA: FAQItem[][] = [
    ...
    [
        { q: "How does Whale Alert Pro exceed Etherscan's transaction tracking?", a: "While Etherscan provides raw ledger data, we provide forensic reconstruction of intents. Our engine decodes complex multichain sequences that explorers often mislabel as generic transfers.", tag: "ARCHITECTURE" },
    ...
    [
        ...
        { q: "What is the 'Yield Farmer' whale alert?", a: "Identification of $1M+ capital entries into new yield optimizers, indicating high-risk high-reward institutional interest.", tag: "YIELD" }
    ],
    ...
    [
        { q: "Is the Whale Alert Pro system compliant with GDPR?", a: "Yes. We analyze public ledger data only and do not associate any PII (Personally Identifiable Information) with wallet addresses.", tag: "PRIVACY" },
    ...
    [
        { q: "Whale Alert v8.4: What changed in this update?", a: "Major improvements to the stochastic engine and sub-15ms sync for cross-platform terminals.", tag: "UPDATE" },
    ...
    [
        ...
        { q: "Market Efficiency: Why use Whale Alert Pro?", a: "Markets become more efficient when transparency is available to all. We provide that transparency with professional tools.", tag: "VALUE" },
    ...
    [
        ...
        { q: "Why is the Whale Alert Pro dashboard white?", a: "Institutional elegance. The Arctic Protocol theme provides maximum contrast for long-duration forensic focus sessions.", tag: "DESIGN" },
    ...
    [
        ...
        { q: "Whale Alert Pro VIP: Is it worth the cost?", a: "For serious institutional participants, the alpha gain from a single alert can cover the cost of a 10-year subscription.", tag: "VALUE" },
        ...
        { q: "The End: Last sovereign query?", a: "Information is freedom. Whale Alert Pro is the gateway to that freedom. Welcome to the Matrix.", tag: "END" }
    ],
    [
        ...
        { q: "Whale Alert 2026: Absolute Perfection?", a: "We don't settle for 'good enough'. We build for absolute, unshakeable perfection.", tag: "MISSION" },
