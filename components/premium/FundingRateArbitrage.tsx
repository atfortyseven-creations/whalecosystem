...
export function FundingRateArbitrage() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#FAFAFA] border border-stone-200 shadow-sm relative overflow-hidden" style={{ backgroundImage: "url('https://www.transparenttextures.com/patterns/cream-paper.png')" }}>
