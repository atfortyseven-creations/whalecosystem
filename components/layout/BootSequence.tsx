...
// --- ZK LORE: Real cryptography texts ---
const ZK_LOGS = [
...
export const BootSequence = () => {
    ...
    const [isHovered, setIsHovered] = useState(false); // Interactivity
    ...
    useEffect(() => {
        ...
        // 2. Loading Sequence
        const duration = 3500; // 3.5 seconds trip
        ...
        const timer = setInterval(() => {
            ...
            // Smooth acceleration curve (Normalized t 0..1)
    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    {/* 1. VIDEO BACKGROUND (CSS WARP SPEED) */}
                    ...
                    {/* 2. CENTRAL INTERFACE (Glassmorphism) */}
                    <motion.div
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            {/* Current Log */}
                            <motion.p
                                key={currentLog} // Re-animate when changed
