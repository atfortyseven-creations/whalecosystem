...
## Humanity Ledger — Zero-Trust On-Chain Intelligence Platform
...
**Project:** Humanity Ledger (Whale Alert Network) — Sovereign Network Architecture v3.0.2
...
|---|---|---|---|
| **Nethermind Security** | UK/EU | Web3, Solidity, ZK | €15,000–35,000 |
| **Trail of Bits** | US (EU office) | Cryptography, Rust, smart contracts | €25,000–60,000 |
| **Hacken** | Ukraine/EU | Web3, pentest, OWASP | €8,000–25,000 |
| **CertiK** | US/EU | Formal verification, Solidity | €15,000–40,000 |
| **Paladin Blockchain Security** | EU | DeFi, privacy protocols | €10,000–30,000 |
| **Zokyo** | US/EU | Full-stack Web3 | €12,000–30,000 |
...
- `services/intelligence/entity-graph-miner.ts` — On-chain data pipeline
...
- **sovereign_handshake JWT** — verify fix for R1 (cookie existence → crypto verification)
...
| Full-stack audit (4 weeks) | €12,000–25,000 |
| Smart contract review | €5,000–15,000 |
| ZK circuit verification | €5,000–10,000 |
| Re-audit + certificate | €2,000–5,000 |
| **Total estimated** | **€24,000–55,000** |
