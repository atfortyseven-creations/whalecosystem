...
2. [Historical Precedent: The Asymmetry Problem](#2-historical-precedent-the-asymmetry-problem)
3. [Architectural Philosophy](#3-architectural-philosophy)
4. [Technology Stack Selection](#4-technology-stack-selection)
5. [The Ingestion Engine](#5-the-ingestion-engine)
6. [The Sovereign Mesh Protocol](#6-the-sovereign-mesh-protocol)
7. [The Akashic Ledger](#7-the-akashic-ledger)
8. [Mass Transfer Intelligence](#8-mass-transfer-intelligence)
9. [The Sovereign Vault](#9-the-sovereign-vault)
10. [Zero-Knowledge Infrastructure](#10-zero-knowledge-infrastructure)
11. [The Data Persistence Layer](#11-the-data-persistence-layer)
12. [The API Surface](#12-the-api-surface)
13. [The Dashboard Terminal](#13-the-dashboard-terminal)
14. [The Landing System](#14-the-landing-system)
15. [Mobile Architecture](#15-mobile-architecture)
16. [Deployment Infrastructure](#16-deployment-infrastructure)
17. [Security Architecture](#17-security-architecture)
18. [Performance Engineering](#18-performance-engineering)
19. [The Visual Design System](#19-the-visual-design-system)
20. [The Wallpaper System](#20-the-wallpaper-system)
21. [The Membership Protocol](#21-the-membership-protocol)
22. [Strategic Roadmap](#22-strategic-roadmap)
23. [Partners and Technology Integrations](#23-partners-and-technology-integrations)
24. [Sponsors and Institutional Supporters](#24-sponsors-and-institutional-supporters)
25. [Appendix: Environment Configuration](#25-appendix-environment-configuration)
...
| Tier       | USD Threshold    | Description                                              |
|------------|-----------------|----------------------------------------------------------|
...
1. **Base layer**: Solid colour fill `#FAF9F6`, which appears anywhere the upper layers are transparent.
2. **Pattern layer**: The patron-cosmico-4k image as a repeating CSS background on a Framer Motion `motion.div`, animated with a 32-second mirror-loop drift.
3. **Wave layer**: The Hokusai Great Wave PNG anchored to the bottom with `position: absolute; bottom: 0; left: 0; width: 100%; height: auto`. The `height: auto` parameter is critical — it allows the image to scale horizontally while preserving the native aspect ratio without distortion.
4. **Vignette layer**: A gradient that fades from the solid base colour through transparent over the top 35 percent and back over the bottom 15 percent, ensuring text contrast at all vertical positions.
...
| `WORLD_ACTION_ID`        | Recommended | World Network action identifier for proof-of-personhood  |
...
# Build the production bundle (only required for deployment validation)
npm run build
```
