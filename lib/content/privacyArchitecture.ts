...
export const PRIVACY_ARCHITECTURE_SECTIONS: PrivacyArchitectureSection[] = [
  // ===== 1. OVERVIEW =====
  {
    ...
    bullets: [
      ...
      'No passwords. No email. Your wallet address is your sovereign identity anchored by ECDSA signatures on secp256k1.',
