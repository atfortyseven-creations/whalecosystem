...
export const NODE_SOLUTIONS: NodeSolution[] = [
    ...
    { id: 'allora', name: 'Allora', description: 'Intelligence-driven decentralized network.', price: '$1000', performance: ['Standard'], mode: ['Full'], networks: ['Testnet'], category: 'NON-EVM' },
