...
const DESCRIPTIONS: Record<number, string[]> = {
  1: [
    "Mutation of the Sovereign Mesh Protocol to assimilate global state in Groth16 rollups. Every Neo4j update generates an on-chain state root, extending the Sub-15ms Ingestion architecture.",
  ...
  3: [
    ...
    "Bloomberg Terminal integration pipeline allowing professional traders to receive Sovereign Intelligence in their current workspace.",
    ...
    "Podcast touring program: 50 episodes in 12 months on top crypto finance channels with exclusive Sovereign Intelligence System data.",
  ],
  4: [
    "Sovereign DAO launch with token-gated access to premium modules using Gold Ticket NFT as a verifiable on-chain membership.",
    ...
    "Intelligence bounty program where the community provides verified on-chain analysis and receives rewards in $WHALE tokens.",
    "Sovereign Discord and Telegram bot broadcasting whale alerts in real-time with enriched on-chain context and dashboard links.",
    ...
    "Internal prediction market where users bet $WHALE on on-chain outcomes, with a sovereign oracle resolving via system data.",
  ],
  5: [
    "Binance Cloud API integration to distribute Sovereign Intelligence as an embedded widget in the Binance interface for 180M users.",
  ...
  6: [
    ...
    "White label licensing for mid-sized exchanges: Sovereign Intelligence under their brand, with a 40% margin for Whalecosystem.",
  ...
  8: [
    ...
    "FIDO2/WebAuthn with Touch ID and Face ID: the Sovereign Vault unlocks biometrically without a password via a passkey registered in an enclave.",
    ...
    "Sovereign Key Derivation: BIP-32 HD wallet with custom sovereign path, sub-key derivation by service, and automatic annual rotation.",
  ...
  10: [
    ...
    "Sovereign CAC LTV Ratio: CAC < $50 for retail Pro, CAC < $5K for enterprise, with LTV of $1200 and $60K respectively.",
...
const COMPETITIVE_EDGES: string[] = [
  ...
  "We eliminate 100% of counterparty risk by operating in Sovereign-Grade mode with no external custodians or intermediaries.",
  "Zero-perceived latency compared to the median 3-second lag of competing Web2 platforms.",
  "We are not passive trackers; we are sovereign multi-cluster executors with autonomous intent-based execution.",
  ...
  "Chainalysis complies with the government; we serve the individual sovereign with zero-knowledge by default.",
  "DeBank shows balance; we predict the next move with whale behavior models.",
  "Zerion has a pretty UI; we have the intelligence engine that no frontend in the world can buy.",
...
const IMPACTS: string[] = [
  ...
  "Positioning as market monopoly in Institutional DeFi Intelligence.",
  ...
  for (let catIndex = 0; catIndex < 10; catIndex++) {
    ...
    for (let itemIndex = 0; itemIndex < 50; itemIndex++) {
      ...
      const overrides: Record<number, Partial<VossDimension>> = {
        1: { title: 'ZK-State Rollup Sovereign Mesh', priority: 'Critical' },
