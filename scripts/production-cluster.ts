...
// 1. Start the Next.js Production Server (Standalone binary)
console.log("🌐 [Web] Starting Next.js Production Engine (Standalone)...");
// We use the server.js generated by 'output: standalone' for maximum performance.
// Use 0.0.0.0 to ensure it's reachable in the container.
process.env.HOSTNAME = '0.0.0.0';
startProcess('WEB-UI', 'node', ['server.js']);
