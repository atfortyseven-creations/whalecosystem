...
export interface MATTERTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "RESERVE_RATIO"
      | "allowance"
...
export interface MATTERToken extends BaseContract {
  connect(runner?: ContractRunner | null): MATTERToken;
  waitForDeployment(): Promise<this>;

  interface: MATTERTokenInterface;
  ...
  buy: TypedContractMethod<[depositAmount: BigNumberish], [void], "nonpayable">;
  ...
  sell: TypedContractMethod<[sellAmount: BigNumberish], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[sellAmount: BigNumberish], [void], "nonpayable">;
  getFunction(
