...
describe('IntelligenceService CU-Shield Verification', () => {
    ...
    it('should respect the metadata cache (Shield Test)', async () => {
        ...
        const meta1 = await intelligenceService.getTokenMetadata(chainId, usdc);
        ...
        const meta2 = await intelligenceService.getTokenMetadata(chainId, usdc);
