...
// ─────────────────────────────────────────────────────────────────────────────
// CHAOS SCENARIO 2: Neo4j Timeout → Memory Matrix Activation
// Validates that EntityGraphMiner falls back cleanly with Zero-Simulation Mandate
// ─────────────────────────────────────────────────────────────────────────────
describe('CHAOS 2: Neo4j Timeout → Memory Matrix', () => {
  it('Memory Matrix returns no fabricated links', async () => {
    // Mock Memory Matrix result (matches mineLocalNetworkGraph return type)
    const mockResult = {
      nodes: [
