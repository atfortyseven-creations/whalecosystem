...
async function sovereignIgnitionCheck() {
...
async function main() {
    ...
    console.log("✅ [Scanner Cluster] All workers launched. Monitoring for sovereign events...");
