  ...
  return (
    <div className="w-full font-sans max-w-[1200px] mx-auto py-12 px-6 lg:px-12">
      ...
      <motion.div initial="hidden" animate="visible" variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.1 } } }} className="w-full flex flex-col lg:flex-row gap-8 mb-16">
        ...
        {/* Left Side: Copy */}
        <motion.div variants={FADE_UP} className="w-full flex flex-col justify-center">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 border border-black/10 rounded-full mb-8 w-fit shadow-sm">
            ...
            <h1 className="text-[48px] md:text-[64px] font-black tracking-tighter uppercase leading-[0.95] mb-6 text-[#050505]">
                Professional <br />
                <span className="text-[#050505]">Documentation.</span>
            </h1>
