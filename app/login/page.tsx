      ...
      <AnimatePresence>
        {showLocalLogin && (
           <motion.div 
             ...
             className="fixed inset-0 z-[100] flex items-center justify-center bg-[#020617]/90 backdrop-blur-xl p-4 sm:p-6"
           >
             <button 
                onClick={() => setShowLocalLogin(false)} 
                className="absolute top-6 right-6 text-white/50 hover:text-white transition-colors uppercase font-black text-xs tracking-widest z-50 bg-white/5 px-4 py-2 rounded-full border border-white/10"
             >
               Cerrar
             </button>
