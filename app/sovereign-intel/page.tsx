...
import { Search, Activity, ArrowUpRight, Zap, Target, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#FDFCF9] text-black font-sans selection:bg-black/10">
      <nav className="fixed top-0 left-0 right-0 p-6 z-50 flex justify-between items-center bg-white/80 backdrop-blur-xl border-b border-black/5">
        <div className="flex items-center gap-3">
          ...
          <span className="font-mono text-[10px] uppercase tracking-[0.4em] font-bold">On-Chain Explorer</span>
        </div>
        {sovereignAddress && (
            ...
            Local Session: {truncate(sovereignAddress)}
            </div>
        )}
      </nav>
