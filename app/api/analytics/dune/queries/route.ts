 ...
 *
 * Sovereign Dune Query Catalog
 *
 * Returns the curated library of ready-to-deploy Dune Analytics SQL queries
 * for on-chain whale intelligence. Each query can be copy-pasted directly
...
const SOVEREIGN_QUERIES = [
    {
        ...
        sql: `
-- Whale Alert Network — Sovereign Dune Query: Volume by Chain
SELECT
    chain,
    COUNT(*)                             AS tx_count,
...
FROM dune_upload.whalealert_sovereign_events
WHERE
...
`.trim(),
    ...
    },
    {
        ...
        sql: `
-- Whale Alert Network — Sovereign Dune Query: Mega Whale Timeline
SELECT
    detected_at,
    chain,
    token,
...
`.trim(),
    ...
    },
    {
        ...
        sql: `
-- Whale Alert Network — Sovereign Dune Query: Token Concentration
SELECT
    token,
...
`.trim(),
    ...
    },
    {
        ...
        sql: `
-- Whale Alert Network — Sovereign Dune Query: Hourly Flow Pattern
SELECT
...
`.trim(),
    ...
    },
    {
        ...
        sql: `
-- Whale Alert Network — Sovereign Dune Query: Repeat Whale Wallets
SELECT
    from_address,
    COUNT(*)                              AS tx_count,
    SUM(usd_value)                        AS total_volume_usd,
...
export async function GET() {
    return NextResponse.json({
        ...
        dataset_table: 'dune_upload.whalealert_sovereign_events',
        ...
        instructions: {
            ...
            step3: 'Name the dataset: whalealert_sovereign_events',
            step4: 'Copy any query from this catalog and run it in the Dune editor',
            step5: 'Share your dashboard publicly to contribute to the Sovereign Intelligence Commons',
        },
    }, {
