    ...
    <div className="relative min-h-screen bg-transparent text-white font-sans antialiased overflow-x-hidden selection:bg-white/10">
      ...
      <header className="w-full max-w-[2560px] mx-auto bg-transparent pt-32 pb-10 px-5 sm:px-8 border-b border-black/10 dark:border-white/10">
        <div className="flex flex-col gap-5 max-w-4xl">
            ...
            <h1 className="text-[52px] md:text-[72px] font-black uppercase tracking-tighter leading-[0.9] text-[#0a0a0a] dark:text-white">
                Build the <span className="text-black/30 dark:text-white/30">Protocol.</span>
            </h1>
            <p className="font-serif text-[18px] md:text-[22px] text-slate-600 dark:text-slate-400 leading-relaxed max-w-3xl">
