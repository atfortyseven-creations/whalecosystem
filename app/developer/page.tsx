       ...
       <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-20">
          ...
          <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className="bg-[#FAF9F6] p-10 hover:bg-black/[0.02] transition-colors border border-black/5 rounded-sm md:row-span-2 flex flex-col justify-between">
                ...
                <Link href="/docs/developer/compendium" className="mt-8 pt-8 border-t border-black/5 font-mono text-[10px] font-bold uppercase tracking-widest text-[#0044CC] flex items-center gap-4 hover:gap-6 transition-all cursor-pointer">
