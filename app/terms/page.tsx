            ...
            <div className="w-full max-w-[1400px] mx-auto pt-32 pb-24 px-6 lg:px-12 flex flex-col items-center">
                ...
                <motion.div initial="hidden" animate="visible" variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.1 } } }} className="w-full text-center flex flex-col items-center mb-24">
                    ...
                    <motion.p variants={FADE_UP} className="font-serif text-[18px] text-slate-500 leading-relaxed max-w-2xl mb-8">
                        The definitive, absolute, and non-negotiable Legal Agreement establishing the exact parameters of interaction between the operator and the System Master Node architecture.
                    </motion.p>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={FADE_UP} className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-[1200px] mx-auto mb-32">
                    ...
                    <div className="bg-white/40 backdrop-blur-3xl border border-black/5 p-10 rounded-[2.5rem] shadow-sm flex flex-col justify-between group hover:shadow-xl transition-all duration-500">
                        <div className="w-full h-[180px] bg-white/40 dark:bg-[#050505]/40 backdrop-blur-3xl rounded-3xl border border-black/5 dark:border-white/5 mb-8 flex flex-col items-center justify-center overflow-hidden gap-4 text-black/20 dark:text-white/20">
                            ...
                            <span className="font-mono text-[10px] font-bold uppercase tracking-widest">Protocol Law</span>
                        </div>
                        <div>
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <h3 className="text-[22px] font-black uppercase tracking-tight text-[#0A0A0A]">Ontological Systemty</h3>
                            </div>
                    ...
                    <div className="bg-white/40 backdrop-blur-3xl border border-black/5 p-10 rounded-[2.5rem] shadow-sm flex flex-col justify-between group hover:shadow-xl transition-all duration-500">
                        <div className="w-full h-[180px] bg-white/40 dark:bg-[#050505]/40 backdrop-blur-3xl rounded-3xl border border-black/5 dark:border-white/5 mb-8 flex flex-col items-center justify-center overflow-hidden gap-4 text-black/20 dark:text-white/20">
                            ...
                            <span className="font-mono text-[10px] font-bold uppercase tracking-widest">Immutable Records</span>
                        </div>
                        <div>
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-10 h-10 rounded-2xl bg-[#0044CC]/10 flex items-center justify-center">
                ...
                <div className="flex flex-col gap-24 w-full max-w-[900px] mx-auto font-serif">
                    ...
                    <section className="flex flex-col md:flex-row gap-8 md:gap-16">
                        ...
                        <div>
                            <h2 className="text-[28px] md:text-[36px] font-black tracking-tight mb-8 text-[#0A0A0A] uppercase">The Nature of the System Contract</h2>
                            <div className="space-y-6 text-slate-600 text-[18px] leading-[1.8] font-medium">
                                <p>
                                    This document constitutes the definitive, absolute, and non-negotiable Legal Agreement establishing the exact parameters of interaction between the operator (hereinafter referred to as "You", "The Operator", or "The User") and the System Master Node architecture (hereinafter referred to as "The Terminal", "The System", or "The Protocol"). By initiating a cryptographic handshake, generating a session token, bypassing the landing grid, or executing queries against our Distributed Graph Database infrastructures, you irrevocably, perpetually, and unconditionally submit to these stringent strictures.
                                </p>
                                <p>
                                    The Terminal is fundamentally distinct from consumer-grade financial applications. It is a highly lethal, institutional-grade analytical engine constructed strictly upon principles of Absolute Systemty, Zero-Mock data integrity, and deterministic network heuristics. Access to the Terminal is an advanced privilege governed by cryptographic, mathematical, and algorithmic constraints, not by conventional consumer rights. 
                                </p>
                                <p>
                    ...
                    <section className="flex flex-col md:flex-row gap-8 md:gap-16">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 text-slate-600 text-[18px] leading-[1.8] font-medium">
                                <p>
                                    Access to the Terminal's deeply restricted analytics matrices is subject exclusively to valid, organic interaction patterns. The system is heavily fortified with Layer-7 Heuristic Anomaly Detection, predictive rate-limiting schemas, and algorithmic bot-mitigation firewalls.
                                </p>
                                <p>
                                ...
                                <p>
                                    Such adversarial actions will result in the immediate, irreversible, and permanent cryptographic banishment of the offending IP grid, associated hardware fingerprints, and all related EOA hashes. We reserve the absolute, uncontestable right to terminate WebSocket access, revoke session tokens, and nullify analytics subscription tiers without prior notification, without right to appeal, and without obligation of refund.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="flex flex-col md:flex-row gap-8 md:gap-16">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 text-slate-600 text-[18px] leading-[1.8] font-medium">
                                <p>
                                    The Terminal's retrospective analytics modules rely extensively on deep-historical state validation queried through decentralized RPC providers, Alchemy, Ankr Archive Nodes, and our proprietary indexing clusters. In the event of catastrophic upstream infrastructure failure, persistent RPC latency, or "missing trie node" synchronization errors on the Ethereum mainnet or subsequent Layer 2 rollups, the Terminal is programmed to degrade gracefully rather than output hallucinatory data.
                                </p>
                                <p>
                                    We accept zero liability for analytics delays, missing block states, or corrupted data frames caused by upstream Layer 1 consensus failures, network forks, node operator malfeasance, or global infrastructure degradation at the foundational protocol layer. The Terminal merely reads the chain; it cannot resurrect pruned states that the broader decentralized network has abandoned.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="flex flex-col md:flex-row gap-8 md:gap-16">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 text-slate-600 text-[18px] leading-[1.8] font-medium">
                                <p>
                                    Institutional actors, system wealth funds, or regulatory bodies requesting verification of specific Akashic records must exclusively utilize our public cryptographic endpoints (e.g., `/api/akashic/verify`) to retrieve the Merkle Root Hash associated with the target epoch. 
                                </p>
                                <p>
