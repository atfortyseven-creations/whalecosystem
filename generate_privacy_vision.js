...
const visionSections = [
  {
    title: "Introduction to the Sovereign Epoch",
    paragraphs: [
      "The digital landscape stands at the precipice of a foundational transformation. For decades, the asymmetry of information has empowered monolithic entities while systematically disenfranchising the sovereign individual. In the realm of decentralized finance, this asymmetry manifests as an invisible architecture where latency, mempool visibility, and cryptographic correlation are monopolized by institutional actors.",
  ...
  },
  {
    ...
    paragraphs: [
      "To build an infrastructure capable of protecting humanity from surveillance capitalism, we must fundamentally reject the concept of trust. Trust is a vulnerability. The Sovereign Master Node operates on the principle of cryptographic verification.",
  ...
  },
  {
    ...
    paragraphs: [
      "The physical constraints of human existence demand mobility. Yet, the computational demands of high-frequency on-chain intelligence require immense local processing power. The Sovereign Protocol resolves this dichotomy through the PWA QR Handshake—a seamless bridge between terrestrial hardware and mobile freedom.",
      ...
      "You carry the omniscient power of an institutional trading desk in your pocket, powered by a localized zero-knowledge bridge. This is the realization of ubiquitous, sovereign intelligence."
    ]
  },
  {
    ...
    paragraphs: [
      ...
      "Through the Sovereign interface, you are granted the capability to perceive these energetic shifts, allowing you to navigate the volatility of global markets with the precision of a high-frequency algorithmic protocol."
    ]
  },
  {
    title: "The Akashic Ledger and Multi-Hop Reality",
    paragraphs: [
      "Capital obfuscates itself through complexity. Institutional actors distribute value across thousands of intermediary addresses to conceal their intentions. To combat this, we have engineered the Akashic Ledger—a Neo4j graph matrix capable of instantaneous multi-hop traversal.",
      ...
      "This capability is no longer the exclusive domain of state actors and quantitative hedge funds. It is now embedded within the local hardware of every Sovereign operator."
    ]
  },
  {
    ...
    paragraphs: [
      ...
      "This cryptographic firewall protects the sanctity of the individual while guaranteeing the absolute integrity of the Sovereign network."
    ]
  },
  {
    title: "The Sovereign Forum: Cryptographic Speech",
    paragraphs: [
      "Freedom of expression is absolute only when it cannot be censored or repudiated. The Sovereign Forum replaces the antiquated mechanisms of username and password with the undeniable reality of ECDSA signatures.",
      ...
      "This architecture guarantees that speech is free, authentic, and immune to central algorithmic suppression. It is a sanctuary for institutional intelligence and sovereign coordination."
    ]
  },
  {
