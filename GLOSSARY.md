...
Understanding the **Whale Alert Network** means understanding the specific terminology used in our architecture and intelligence reporting.
...
- **Sovereign Vault**: The local, secured instance of our platform running on your hardware. It ensures your data, queries, and connected wallets are never exposed to external servers.
